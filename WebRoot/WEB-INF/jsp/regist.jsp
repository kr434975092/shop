...
<script>
	...
	function change()
	{
		var src1="${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();
		$("#checkImg").attr('src',src1);	
	}
</script>
</head>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  method="post" novalidate="novalidate" onsubmit="return checkForm();" action="${ pageContext.request.contextPath }/user_regist.action">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
